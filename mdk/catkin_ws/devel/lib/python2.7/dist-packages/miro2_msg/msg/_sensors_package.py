...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.cliff.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.cliff.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.cliff.data))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.kinematic_joints.position))
      length = len(self.kinematic_joints.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.kinematic_joints.velocity))
      length = len(self.kinematic_joints.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.kinematic_joints.effort))
      ...
      for val1 in self.light.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.light.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.light.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.light.data))
      _x = self
      ...
      for val1 in self.stream.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.stream.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.stream.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.Struct(pattern).pack(*self.stream.data))
      _x = self
      ...
      for val1 in self.wheel_speed_cmd.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.wheel_speed_cmd.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.wheel_speed_cmd.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_speed_cmd.data))
      ...
      for val1 in self.wheel_speed_back_emf.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.wheel_speed_back_emf.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.wheel_speed_back_emf.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_speed_back_emf.data))
      ...
      for val1 in self.wheel_speed_opto.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.wheel_speed_opto.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.wheel_speed_opto.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_speed_opto.data))
      ...
      for val1 in self.wheel_effort_pwm.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      _x = self.wheel_effort_pwm.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.wheel_effort_pwm.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_effort_pwm.data))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.cliff.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 18
      ...
      if python3:
        self.imu_head.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.imu_body.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.kinematic_joints.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.kinematic_joints.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.kinematic_joints.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.kinematic_joints.effort = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.light.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.sonar.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.stream.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 4
      ...
      self.wheel_speed_cmd.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.wheel_speed_back_emf.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.wheel_speed_opto.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.wheel_effort_pwm.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 24
