...
PLATFORM_U_FLAG_SIMULATOR = __BIT(15)
...
LOC_IMU_BODY_X = (-0.095)
LOC_IMU_BODY_Y = (0.048)
LOC_IMU_BODY_Z = (0.010)

#	location of IMU in HEAD
LOC_IMU_HEAD_X = (0.050)
LOC_IMU_HEAD_Y = (0.040)
LOC_IMU_HEAD_Z = (0.025)
...
ILLUM_RM = __BIT(4)
ILLUM_RR = __BIT(5)
ILLUM_L = (ILLUM_LF | ILLUM_LM | ILLUM_LR)
ILLUM_R = (ILLUM_RF | ILLUM_RM | ILLUM_RR)
ILLUM_FRONT = (ILLUM_LF | ILLUM_RF)
ILLUM_MID = (ILLUM_LM | ILLUM_RM)
ILLUM_REAR = (ILLUM_LR | ILLUM_RR)
ILLUM_ALL = (ILLUM_L | ILLUM_R)
