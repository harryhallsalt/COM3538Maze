...
class funnel_web(genpy.Message):
  _md5sum = "b87a00cb6c8790611893cdfdfbec2fc4"
...
uint8 data
"""
  __slots__ = ['cliff','light','sonar','touch','illum','audio_level','tone','img_ann']
  _slot_types = ['float32[2]','float32[4]','float32','uint16[2]','uint32[6]','float32','uint16[3]','miro2_msg/img_annotation']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       cliff,light,sonar,touch,illum,audio_level,tone,img_ann
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_I().pack(self.img_ann.centre.layout.data_offset))
      length = len(self.img_ann.centre.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.img_ann.centre.data))
      ...
      for val1 in self.img_ann.vertices.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      buff.write(_get_struct_I().pack(self.img_ann.vertices.layout.data_offset))
      length = len(self.img_ann.vertices.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.img_ann.vertices.data))
      _x = self
      buff.write(_get_struct_fIBf().pack(_x.img_ann.size.data, _x.img_ann.area.data, _x.img_ann.id.data, _x.img_ann.distance.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.img_ann.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.img_ann.type.data = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.img_ann.cam.data = str[start:end].decode('utf-8')
      else:
      ...
      self.img_ann.centre.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.img_ann.vertices.data = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 13
      (_x.img_ann.size.data, _x.img_ann.area.data, _x.img_ann.id.data, _x.img_ann.distance.data,) = _get_struct_fIBf().unpack(str[start:end])
      return self
...
def _get_struct_4f():
    ...
    return _struct_4f
_struct_fIBf = None
def _get_struct_fIBf():
    global _struct_fIBf
    if _struct_fIBf is None:
        _struct_fIBf = struct.Struct("<fIBf")
    return _struct_fIBf
_struct_2H = None
def _get_struct_2H():
    global _struct_2H
