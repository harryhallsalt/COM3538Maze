...
bool operator==(const ::miro2_msg::animal_state_<ContainerAllocator1> & lhs, const ::miro2_msg::animal_state_<ContainerAllocator2> & rhs)
{
  return lhs.flags == rhs.flags &&
    lhs.emotion == rhs.emotion &&
    lhs.mood == rhs.mood &&
    lhs.sleep == rhs.sleep &&
    lhs.time_of_day == rhs.time_of_day &&
