...
"""autogenerated by genpy from miro2_msg/sleep.msg. Do not edit."""
import sys
...
class sleep(genpy.Message):
  _md5sum = "9ae301b8349f95e1749450e5431eef09"
  _type = "miro2_msg/sleep"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(sleep, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2f().pack(_x.wakefulness, _x.pressure))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.wakefulness, _x.pressure,) = _get_struct_2f().unpack(str[start:end])
      return self
