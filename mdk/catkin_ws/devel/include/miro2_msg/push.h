...
bool operator==(const ::miro2_msg::push_<ContainerAllocator1> & lhs, const ::miro2_msg::push_<ContainerAllocator2> & rhs)
{
  return lhs.link == rhs.link &&
    lhs.flags == rhs.flags &&
    lhs.pushpos == rhs.pushpos &&
    lhs.pushvec == rhs.pushvec;
}
