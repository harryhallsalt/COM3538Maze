...
struct img_annotation_
{
  ...
  _size_type size;
   ...
   typedef  ::std_msgs::UInt32_<ContainerAllocator>  _area_type;
  _area_type area;
...
struct MD5Sum< ::miro2_msg::img_annotation_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7bf8afed4c25742cULL;
  static const uint64_t static_value2 = 0x478ea0e99433135cULL;
};
...
struct Printer< ::miro2_msg::img_annotation_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::miro2_msg::img_annotation_<ContainerAllocator>& v)
  {
    ...
    s << indent << "area: ";
    s << std::endl;
    Printer< ::std_msgs::UInt32_<ContainerAllocator> >::stream(s, indent + "  ", v.area);
    s << indent << "id: ";
    s << std::endl;
