...
//	location of IMU in BODY
#define MIRO_LOC_IMU_BODY_X (-0.095f)
#define MIRO_LOC_IMU_BODY_Y (0.048f)
#define MIRO_LOC_IMU_BODY_Z (0.010f)

//	location of IMU in HEAD
#define MIRO_LOC_IMU_HEAD_X (0.050f)
#define MIRO_LOC_IMU_HEAD_Y (0.040f)
#define MIRO_LOC_IMU_HEAD_Z (0.025f)

//	location of sonar in HEAD
#define MIRO_LOC_SONAR_X (0.082f)
#define MIRO_LOC_SONAR_Y (0.000f)
#define MIRO_LOC_SONAR_Z (0.035f)

//	location of sonar fovea in HEAD
#define MIRO_LOC_SONAR_FOVEA_X (0.125f)
#define MIRO_LOC_SONAR_FOVEA_Y (0.000f)
#define MIRO_LOC_SONAR_FOVEA_Z (0.035f)
...
//	mic sensor identifiers
#define MIRO_MIC_L									0
#define MIRO_MIC_R									1
#define MIRO_MIC_C									2
#define MIRO_MIC_T									3

//	imu sensor identifiers
#define MIRO_IMU_B									0
#define MIRO_IMU_H									1

//	illum identifiers
#define MIRO_ILLUM_LF								__BIT(0)
#define MIRO_ILLUM_LM								__BIT(1)
#define MIRO_ILLUM_LR								__BIT(2)
#define MIRO_ILLUM_RF								__BIT(3)
#define MIRO_ILLUM_RM								__BIT(4)
#define MIRO_ILLUM_RR								__BIT(5)
#define MIRO_ILLUM_L								(MIRO_ILLUM_LF | MIRO_ILLUM_LM | MIRO_ILLUM_LR)
#define MIRO_ILLUM_R								(MIRO_ILLUM_RF | MIRO_ILLUM_RM | MIRO_ILLUM_RR)								
#define MIRO_ILLUM_FRONT							(MIRO_ILLUM_LF | MIRO_ILLUM_RF)
#define MIRO_ILLUM_MID								(MIRO_ILLUM_LM | MIRO_ILLUM_RM)
#define MIRO_ILLUM_REAR								(MIRO_ILLUM_LR | MIRO_ILLUM_RR)
#define MIRO_ILLUM_ALL								(MIRO_ILLUM_L | MIRO_ILLUM_R)
