...
class img_annotation {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('area')) {
        ...
        this.area = new std_msgs.msg.UInt32();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = std_msgs.msg.UInt32.serialize(obj.area, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.area = std_msgs.msg.UInt32.deserialize(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '7bf8afed4c25742c478ea0e99433135c';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.area !== undefined) {
      resolved.area = std_msgs.msg.UInt32.Resolve(msg.area)
    }
    else {
      resolved.area = new std_msgs.msg.UInt32()
    }
