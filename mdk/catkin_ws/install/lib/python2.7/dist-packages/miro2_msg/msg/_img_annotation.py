...
class img_annotation(genpy.Message):
  _md5sum = "7bf8afed4c25742c478ea0e99433135c"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/String','std_msgs/String','std_msgs/Float32MultiArray','std_msgs/Float32MultiArray','std_msgs/Float32','std_msgs/UInt32','std_msgs/UInt8','std_msgs/Float32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_I().pack(self.centre.layout.data_offset))
      length = len(self.centre.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.centre.data))
      ...
      for val1 in self.vertices.layout.dim:
        ...
        _x = val1
        buff.write(_get_struct_2I().pack(_x.size, _x.stride))
      buff.write(_get_struct_I().pack(self.vertices.layout.data_offset))
      length = len(self.vertices.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.vertices.data))
      _x = self
      buff.write(_get_struct_fIBf().pack(_x.size.data, _x.area.data, _x.id.data, _x.distance.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.cam.data = str[start:end].decode('utf-8')
      else:
      ...
      self.centre.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.vertices.data = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 13
      (_x.size.data, _x.area.data, _x.id.data, _x.distance.data,) = _get_struct_fIBf().unpack(str[start:end])
      return self
